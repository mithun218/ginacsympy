...
/** This class is the ABC (abstract base class) of ginacsym's class hierarchy. */
...
public:
	...
	virtual void accept(ginacsym::visitor & v) const
	{
    ...
    virtual ex power_expand(unsigned options = 0) const;
...
/** Constructs a new (class basic or derived) B object on the heap.
 *
 *  This function is needed for ginacsym classes which have public ctors from
