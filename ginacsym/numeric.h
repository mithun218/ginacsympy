...
class indeterminate_error : public std::domain_error {
public:
    explicit indeterminate_error(const std::string& what_arg);
};


/** This class is a wrapper around CLN-numbers within the ginacsym class
