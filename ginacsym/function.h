...
template< typename T1 > const ginacsym::function NAME( const T1 & p1 ) { \
	return ginacsym::function(NAME##_SERIAL::serial, ginacsym::ex(p1) ); \
}
#define DECLARE_FUNCTION_2P(NAME) \
class NAME##_SERIAL { public: static unsigned serial; }; \
const unsigned NAME##_NPARAMS = 2; \
template< typename T1, typename T2 > const ginacsym::function NAME( const T1 & p1, const T2 & p2 ) { \
	return ginacsym::function(NAME##_SERIAL::serial, ginacsym::ex(p1), ginacsym::ex(p2) ); \
}
#define DECLARE_FUNCTION_3P(NAME) \
class NAME##_SERIAL { public: static unsigned serial; }; \
const unsigned NAME##_NPARAMS = 3; \
template< typename T1, typename T2, typename T3 > const ginacsym::function NAME( const T1 & p1, const T2 & p2, const T3 & p3 ) { \
	return ginacsym::function(NAME##_SERIAL::serial, ginacsym::ex(p1), ginacsym::ex(p2), ginacsym::ex(p3) ); \
}
#define DECLARE_FUNCTION_4P(NAME) \
class NAME##_SERIAL { public: static unsigned serial; }; \
const unsigned NAME##_NPARAMS = 4; \
template< typename T1, typename T2, typename T3, typename T4 > const ginacsym::function NAME( const T1 & p1, const T2 & p2, const T3 & p3, const T4 & p4 ) { \
	return ginacsym::function(NAME##_SERIAL::serial, ginacsym::ex(p1), ginacsym::ex(p2), ginacsym::ex(p3), ginacsym::ex(p4) ); \
}
#define DECLARE_FUNCTION_5P(NAME) \
class NAME##_SERIAL { public: static unsigned serial; }; \
const unsigned NAME##_NPARAMS = 5; \
template< typename T1, typename T2, typename T3, typename T4, typename T5 > const ginacsym::function NAME( const T1 & p1, const T2 & p2, const T3 & p3, const T4 & p4, const T5 & p5 ) { \
	return ginacsym::function(NAME##_SERIAL::serial, ginacsym::ex(p1), ginacsym::ex(p2), ginacsym::ex(p3), ginacsym::ex(p4), ginacsym::ex(p5) ); \
}
#define DECLARE_FUNCTION_6P(NAME) \
class NAME##_SERIAL { public: static unsigned serial; }; \
const unsigned NAME##_NPARAMS = 6; \
template< typename T1, typename T2, typename T3, typename T4, typename T5, typename T6 > const ginacsym::function NAME( const T1 & p1, const T2 & p2, const T3 & p3, const T4 & p4, const T5 & p5, const T6 & p6 ) { \
	return ginacsym::function(NAME##_SERIAL::serial, ginacsym::ex(p1), ginacsym::ex(p2), ginacsym::ex(p3), ginacsym::ex(p4), ginacsym::ex(p5), ginacsym::ex(p6) ); \
}
#define DECLARE_FUNCTION_7P(NAME) \
class NAME##_SERIAL { public: static unsigned serial; }; \
const unsigned NAME##_NPARAMS = 7; \
template< typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7 > const ginacsym::function NAME( const T1 & p1, const T2 & p2, const T3 & p3, const T4 & p4, const T5 & p5, const T6 & p6, const T7 & p7 ) { \
	return ginacsym::function(NAME##_SERIAL::serial, ginacsym::ex(p1), ginacsym::ex(p2), ginacsym::ex(p3), ginacsym::ex(p4), ginacsym::ex(p5), ginacsym::ex(p6), ginacsym::ex(p7) ); \
}
#define DECLARE_FUNCTION_8P(NAME) \
class NAME##_SERIAL { public: static unsigned serial; }; \
const unsigned NAME##_NPARAMS = 8; \
template< typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7, typename T8 > const ginacsym::function NAME( const T1 & p1, const T2 & p2, const T3 & p3, const T4 & p4, const T5 & p5, const T6 & p6, const T7 & p7, const T8 & p8 ) { \
	return ginacsym::function(NAME##_SERIAL::serial, ginacsym::ex(p1), ginacsym::ex(p2), ginacsym::ex(p3), ginacsym::ex(p4), ginacsym::ex(p5), ginacsym::ex(p6), ginacsym::ex(p7), ginacsym::ex(p8) ); \
}
#define DECLARE_FUNCTION_9P(NAME) \
class NAME##_SERIAL { public: static unsigned serial; }; \
const unsigned NAME##_NPARAMS = 9; \
template< typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7, typename T8, typename T9 > const ginacsym::function NAME( const T1 & p1, const T2 & p2, const T3 & p3, const T4 & p4, const T5 & p5, const T6 & p6, const T7 & p7, const T8 & p8, const T9 & p9 ) { \
	return ginacsym::function(NAME##_SERIAL::serial, ginacsym::ex(p1), ginacsym::ex(p2), ginacsym::ex(p3), ginacsym::ex(p4), ginacsym::ex(p5), ginacsym::ex(p6), ginacsym::ex(p7), ginacsym::ex(p8), ginacsym::ex(p9) ); \
}
#define DECLARE_FUNCTION_10P(NAME) \
class NAME##_SERIAL { public: static unsigned serial; }; \
const unsigned NAME##_NPARAMS = 10; \
template< typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7, typename T8, typename T9, typename T10 > const ginacsym::function NAME( const T1 & p1, const T2 & p2, const T3 & p3, const T4 & p4, const T5 & p5, const T6 & p6, const T7 & p7, const T8 & p8, const T9 & p9, const T10 & p10 ) { \
	return ginacsym::function(NAME##_SERIAL::serial, ginacsym::ex(p1), ginacsym::ex(p2), ginacsym::ex(p3), ginacsym::ex(p4), ginacsym::ex(p5), ginacsym::ex(p6), ginacsym::ex(p7), ginacsym::ex(p8), ginacsym::ex(p9), ginacsym::ex(p10) ); \
}
#define DECLARE_FUNCTION_11P(NAME) \
class NAME##_SERIAL { public: static unsigned serial; }; \
const unsigned NAME##_NPARAMS = 11; \
template< typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7, typename T8, typename T9, typename T10, typename T11 > const ginacsym::function NAME( const T1 & p1, const T2 & p2, const T3 & p3, const T4 & p4, const T5 & p5, const T6 & p6, const T7 & p7, const T8 & p8, const T9 & p9, const T10 & p10, const T11 & p11 ) { \
	return ginacsym::function(NAME##_SERIAL::serial, ginacsym::ex(p1), ginacsym::ex(p2), ginacsym::ex(p3), ginacsym::ex(p4), ginacsym::ex(p5), ginacsym::ex(p6), ginacsym::ex(p7), ginacsym::ex(p8), ginacsym::ex(p9), ginacsym::ex(p10), ginacsym::ex(p11) ); \
}
#define DECLARE_FUNCTION_12P(NAME) \
class NAME##_SERIAL { public: static unsigned serial; }; \
const unsigned NAME##_NPARAMS = 12; \
template< typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7, typename T8, typename T9, typename T10, typename T11, typename T12 > const ginacsym::function NAME( const T1 & p1, const T2 & p2, const T3 & p3, const T4 & p4, const T5 & p5, const T6 & p6, const T7 & p7, const T8 & p8, const T9 & p9, const T10 & p10, const T11 & p11, const T12 & p12 ) { \
	return ginacsym::function(NAME##_SERIAL::serial, ginacsym::ex(p1), ginacsym::ex(p2), ginacsym::ex(p3), ginacsym::ex(p4), ginacsym::ex(p5), ginacsym::ex(p6), ginacsym::ex(p7), ginacsym::ex(p8), ginacsym::ex(p9), ginacsym::ex(p10), ginacsym::ex(p11), ginacsym::ex(p12) ); \
}
#define DECLARE_FUNCTION_13P(NAME) \
class NAME##_SERIAL { public: static unsigned serial; }; \
const unsigned NAME##_NPARAMS = 13; \
template< typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7, typename T8, typename T9, typename T10, typename T11, typename T12, typename T13 > const ginacsym::function NAME( const T1 & p1, const T2 & p2, const T3 & p3, const T4 & p4, const T5 & p5, const T6 & p6, const T7 & p7, const T8 & p8, const T9 & p9, const T10 & p10, const T11 & p11, const T12 & p12, const T13 & p13 ) { \
	return ginacsym::function(NAME##_SERIAL::serial, ginacsym::ex(p1), ginacsym::ex(p2), ginacsym::ex(p3), ginacsym::ex(p4), ginacsym::ex(p5), ginacsym::ex(p6), ginacsym::ex(p7), ginacsym::ex(p8), ginacsym::ex(p9), ginacsym::ex(p10), ginacsym::ex(p11), ginacsym::ex(p12), ginacsym::ex(p13) ); \
}
#define DECLARE_FUNCTION_14P(NAME) \
class NAME##_SERIAL { public: static unsigned serial; }; \
const unsigned NAME##_NPARAMS = 14; \
template< typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7, typename T8, typename T9, typename T10, typename T11, typename T12, typename T13, typename T14 > const ginacsym::function NAME( const T1 & p1, const T2 & p2, const T3 & p3, const T4 & p4, const T5 & p5, const T6 & p6, const T7 & p7, const T8 & p8, const T9 & p9, const T10 & p10, const T11 & p11, const T12 & p12, const T13 & p13, const T14 & p14 ) { \
	return ginacsym::function(NAME##_SERIAL::serial, ginacsym::ex(p1), ginacsym::ex(p2), ginacsym::ex(p3), ginacsym::ex(p4), ginacsym::ex(p5), ginacsym::ex(p6), ginacsym::ex(p7), ginacsym::ex(p8), ginacsym::ex(p9), ginacsym::ex(p10), ginacsym::ex(p11), ginacsym::ex(p12), ginacsym::ex(p13), ginacsym::ex(p14) ); \
}
// end of generated lines

#define REGISTER_FUNCTION(NAME,OPT) \
unsigned NAME##_SERIAL::serial = \
	ginacsym::function::register_new(ginacsym::function_options(#NAME, NAME##_NPARAMS).OPT);
...
#define is_ex_the_function(OBJ, FUNCNAME) (ginacsym::is_the_function<FUNCNAME##_SERIAL>(OBJ))
