/** @file archive.h
 *
 *  Archiving of ginacsym expressions. */
 ...
 * from ginacsym::basic) can be archived and unarchived.
 *
...
{								\
	static ginacsym::unarchive_table_t table;			\
	if (usecount++ == 0) {					\
		table.insert(std::string(#classname),		\
			&(classname ## _unarchiver::create));	\
	}							\
}								\
ginacsym::basic* classname ## _unarchiver::create()		\
{								\
...
/** This class holds archived versions of ginacsym expressions (class ex).
