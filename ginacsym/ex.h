/** @file ex.h
 *
 *  Interface to ginacsym's light-weight expression handles. */
...
/** Lightweight wrapper for ginacsym's symbolic objects.  It holds a pointer to
...
public:
	 ...
	 *  similar to the ginacsym output format. All symbols and indices to be used
...
public:
    ...
    //ex imap(imap_function& f)const{return bp->map(f);}
	...
	// expand/collect
    ex power_expand(unsigned options=0) const;
...
public:
    ...
    ex expr_visitor(const ex & e) override { return ptr(e); }
};
...
public:
    ...
    ex expr_visitor(const ex & e) override { return ptr(e, arg1); }
};
...
public:
    ...
    ex expr_visitor(const ex & e) override { return ptr(e, arg1, arg2); }
};
...
public:
    ...
    ex expr_visitor(const ex & e) override { return ptr(e, arg1, arg2, arg3); }
};
...
public:
    ...
    ex expr_visitor(const ex & e) override { return (c.*ptr)(e); }
};
...
public:
    ...
    ex expr_visitor(const ex & e) override { return (c.*ptr)(e, arg1); }
};
...
public:
    ...
    ex expr_visitor(const ex & e) override { return (c.*ptr)(e, arg1, arg2); }
};
...
public:
    ...
    ex expr_visitor(const ex & e) override { return (c.*ptr)(e, arg1, arg2, arg3); }
};
 ...
 *  the returned reference because ginacsym's garbage collector may destroy
...
template <>
inline void swap(ginacsym::ex &a, ginacsym::ex &b)
{
	a.swap(b);
}
...
template<>
struct hash<ginacsym::ex>
{
	std::size_t operator()(const ginacsym::ex & e) const noexcept
	{
		return e.gethash();
	}
};
...
template<>
struct equal_to<ginacsym::ex>
{
	bool operator()(const ginacsym::ex &e1, const ginacsym::ex &e2) const noexcept
	{
