/** @file registrar.h
 *
 *  ginacsym's class registrar (for class basic and all classes derived from it). */
...
/** This class stores information about a registered ginacsym class. */
...
private: \
	static ginacsym::registered_class_info reg_info; \
public: \
	static ginacsym::registered_class_info &get_class_info_static() { return reg_info; } \
	class visitor { \
	public: \
...
#define GINAC_DECLARE_REGISTERED_CLASS_NO_CTORS(classname, supername) \
	...
	virtual const ginacsym::registered_class_info &get_class_info() const { return classname::get_class_info_static(); } \
	virtual ginacsym::registered_class_info &get_class_info() { return classname::get_class_info_static(); } \
 ...
 *  from 'basic' as well as all required stuff for the ginacsym class
...
#define GINAC_DECLARE_REGISTERED_CLASS(classname, supername) \
	...
	classname * duplicate() const override { \
		...
		bp->setflag(ginacsym::status_flags::dynallocated);	\
		return bp; \
	} \
	\
	void accept(ginacsym::visitor & v) const override \
	{ \
	...
	const ginacsym::registered_class_info &get_class_info() const override { return classname::get_class_info_static(); } \
	ginacsym::registered_class_info &get_class_info() override { return classname::get_class_info_static(); } \
	const char *class_name() const override { return classname::get_class_info_static().options.get_name(); } \
protected: \
	int compare_same_type(const ginacsym::basic & other) const override; \
private:


/** Macro for inclusion in the implementation of each registered class. */
#define GINAC_IMPLEMENT_REGISTERED_CLASS(classname, supername) \
	ginacsym::registered_class_info classname::reg_info = ginacsym::registered_class_info(ginacsym::registered_class_options(#classname, #supername, typeid(classname))); 

/** Macro for inclusion in the implementation of each registered class.
 *  Additional options can be specified. */
#define GINAC_IMPLEMENT_REGISTERED_CLASS_OPT(classname, supername, options) \
	ginacsym::registered_class_info classname::reg_info = ginacsym::registered_class_info(ginacsym::registered_class_options(#classname, #supername, typeid(classname)).options);
