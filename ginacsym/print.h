...
public: \
	...
	static const ginacsym::print_context_class_info &get_class_info_static(); \
	classname();

#define GINAC_DECLARE_PRINT_CONTEXT_BASE(classname) \
	GINAC_DECLARE_PRINT_CONTEXT_COMMON(classname) \
	virtual const ginacsym::print_context_class_info &get_class_info() const { return classname::get_class_info_static(); } \
 ...
 *  from 'print_context' as well as all required stuff for the ginacsym
 *  registry. */
#define GINAC_DECLARE_PRINT_CONTEXT(classname, supername) \
	GINAC_DECLARE_PRINT_CONTEXT_COMMON(classname) \
	typedef supername inherited; \
	const ginacsym::print_context_class_info &get_class_info() const override { return classname::get_class_info_static(); } \
...
const ginacsym::print_context_class_info &classname::get_class_info_static() \
{ \
	static ginacsym::print_context_class_info reg_info = ginacsym::print_context_class_info(ginacsym::print_context_options(#classname, #supername, ginacsym::next_print_context_id++)); \
	return reg_info; \
}
