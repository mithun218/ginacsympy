/** @file flags.h
 *
 *  Collection of all flags used through the ginacsym framework. */
...
public:
	enum {
        ...
        power_expanded  = 0x0300, ///< .power_expand(0) has already done its job (other power_expand() options ignore this flag)
...
/**Flags to simplify the algebraic expressions**/
