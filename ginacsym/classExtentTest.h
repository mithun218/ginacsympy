...
#ifndef GINAC_relational1_H
#define GINAC_relational1_H
...
class relational1 : public basic
{
    GINAC_DECLARE_REGISTERED_CLASS(relational1, basic)
...
public:
    ...
    // other constructors
public:
    relational1(const ex & lhs, const ex & rhs, operators oper=equal);
...
private:
    ...
    // use of relational1 objects in conditionals without those side effects
...
//GINAC_DECLARE_UNARCHIVER(relational1);

// utility functions

// inlined functions for efficiency
//inline relational1::safe_bool relational1::operator!() const
//{
...
#endif // ndef GINAC_relational1_H
